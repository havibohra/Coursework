...
def main():
    ...
    output_folder = "results/plots_pushNpull"
    ...
    for n in n_values:
        ...
        K_values = np.linspace(0.4 , 2, 200)
    ...
    plt.plot(n_values, 0.75*results_df["log(n)"], marker='x', linestyle='--', color='green', label='0.75*log(n)')
    plt.plot(n_values, results_df["log(n)"], marker='x', linestyle='--', color='blue', label='log(n)')
